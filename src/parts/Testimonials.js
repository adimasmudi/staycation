...
import TestimonyAccent  from 'assets/images/Rectangle 2.jpg';
        ...
        <section className="container">
            <div className="row align-items-center">
                ...
                <div className="col">
                    ...
                    <div>
                        <Button className="btn px-5" style={{marginTop:40}} hasShadow isPrimary type="link" href={`/testimonials/${data._id}`}>Read their story</Button>
                    </div>
                </div>
            </div>
